...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeStyles(\App\Library\PHPExcel $pPHPExcel = null)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeCellStyleXf(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Style $pStyle = null, \App\Library\PHPExcel $pPHPExcel = null)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allStyles(\App\Library\PHPExcel $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allConditionalStyles(\App\Library\PHPExcel $pPHPExcel = null)
    {
        // Get an array of all styles
        $aStyles = array();
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allFills(\App\Library\PHPExcel $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allFonts(\App\Library\PHPExcel $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allBorders(\App\Library\PHPExcel $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function allNumberFormats(\App\Library\PHPExcel $pPHPExcel = null)
    {
