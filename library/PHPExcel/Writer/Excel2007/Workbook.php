...
class PHPExcel_Writer_Excel2007_Workbook extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeWorkbook(\App\Library\PHPExcel $pPHPExcel = null, $recalcRequired = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeBookViews(PHPExcel_Shared_XMLWriter $objWriter = null, \App\Library\PHPExcel $pPHPExcel = null)
    {
        // bookViews
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeWorkbookProtection(PHPExcel_Shared_XMLWriter $objWriter = null, \App\Library\PHPExcel $pPHPExcel = null)
    {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeSheets(PHPExcel_Shared_XMLWriter $objWriter = null, \App\Library\PHPExcel $pPHPExcel = null)
    {
        // Write sheets
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    private function writeDefinedNames(PHPExcel_Shared_XMLWriter $objWriter = null, \App\Library\PHPExcel $pPHPExcel = null)
    {
        // Write defined names
