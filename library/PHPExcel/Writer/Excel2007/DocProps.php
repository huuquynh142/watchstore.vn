...
class PHPExcel_Writer_Excel2007_DocProps extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeDocPropsApp(\App\Library\PHPExcel $pPHPExcel = null)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeDocPropsCore(\App\Library\PHPExcel $pPHPExcel = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @throws     PHPExcel_Writer_Exception
     */
    public function writeDocPropsCustom(\App\Library\PHPExcel $pPHPExcel = null)
    {
